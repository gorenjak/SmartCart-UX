...
async function getPublicKey() {
  try {
    const response = await fetch('https://smartcart-push-notification.onrender.com/api/publicKey');
...
async function registerPushNotification(publicKey) {
  try {
    ...
    await fetch('https://smartcart-push-notification.onrender.com/api/push/subscribe', {
      method: 'POST',
...
loginForm.addEventListener('submit', async function(event) {
  ...
  const response = await fetch('https://smartcart-l7l2.onrender.com/api/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
resetPasswordForm.addEventListener('submit', async function(event) {
  ...
  const response = await fetch('https://smartcart-l7l2.onrender.com/api/reset-password', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
