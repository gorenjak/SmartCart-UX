...
const socket = io('https://smartcart-shopping-list.onrender.com');
...
const apiUrl = 'https://smartcart-shopping-list.onrender.com/api/shopping-lists';
...
async function shareList(event) {
  ...
  try {
    ...
    const userResponse = await fetch(`https://smartcart-l7l2.onrender.com/api/users/email/${email}`, {
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
    });
    ...
    const shareResponse = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${listId}/share`, {
      method: 'POST',
      headers: {
...
async function displayShoppingLists() {
  ...
  try {
    const response = await fetch('https://smartcart-shopping-list.onrender.com/api/shopping-lists', {
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
    });
    ...
    for (const list of shoppingLists) {
      ...
      const productsResponse = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${list._id}`, {
        headers: {
          'Authorization': `Bearer ${accessToken}`
        }
      });
      ...
      card.innerHTML += `
        ...
        <button onclick="deleteList('${list._id}')" class="button-style secondary-button">Izbriši seznam</button>
        <button onclick="sendShoppingList('${list._id}')" class="button-style secondary-button">
        Pošlji
        <img src="assets/email.png" alt="Pošlji" style="width: 14px;" class="img-button">
        </button>
        <button onclick="showShareModal('${list._id}')" class="button-style secondary-button">
        Deli
...
async function saveListName(listId) {
  ...
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${listId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${accessToken}`
...
async function deleteProduct(listId, productId) {
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${listId}/products/${productId}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
...
async function deleteList(id) {
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
...
async function addProduct(event) {
  ...
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${listId}/products`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${accessToken}`
...
async function addProductToList(product, listId) {
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/shopping-lists/${listId}/products/${product._id}`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${accessToken}`,
        'Content-Type': 'application/json'
...
document.getElementById('edit-product-form').addEventListener('submit', async function(event) {
  ...
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/products/${productId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${accessToken}`
...
async function displayExistingProducts(userId, listId) {
  try {
    const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/users/${userId}/products`, {
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
    });
  ...
  try {
    ...
    const handleSubmit = async function(event) {
      ...
      try {
        ...
        const response = await fetch(`https://smartcart-shopping-list.onrender.com/api/send-shopping-list/${listId}`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${accessToken}`
